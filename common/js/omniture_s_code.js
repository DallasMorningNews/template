...
//var s_account="bibadcodecom";
var siteName=window.location.hostname;
siteName=siteName.toString().replace(/\./, "").replace("'","");

//var s_account=om_location_domain + ", bi" + siteName;
var s_account="";
s_account = (window.s_account2) ? s_account2 : s_account;
...
s.linkInternalFilters=om_linkInternalFilters;
s.fpcdomain=om_fpcdomain;
/* Plugin Config */
s.usePlugins=true;
function s_doPlugins(s) {
	/* Add calls to plugins here */

/* Set External Campaigns */
s.campaign=s.getQueryParam('iq_id');
s.campaign=s.getValOnce(s.campaign,'s_iq_id',0)

/* Set Page View Event */
s.events=s.apl(s.events,'event9',',',2)

/* Set Persisted Values */
s.prop22=s.getAndPersistValue(s.eVar29,'s_ev29_persist',30);
s.prop23=s.getAndPersistValue(s.eVar30,'s_ev30_persist',30);

/* Set Visit Number */
s.eVar25=s.prop25=s.getVisitNum();

/* Set Days Since Last Visit */
s.eVar26=s.prop26=s.getDaysSinceLastVisit();

/* Set New vs. Repeat */
s.eVar27=s.prop27=s.getNewRepeat();
...
s.trackingServer="metrics.dallasnews.com"
s.trackingServerSecure="smetrics.dallasnews.com"
